...
from utils.options import args_parser_fedhypgrad_2
from models.client_HypGrad_2 import LocalClient_HypGrad
...
from utils.util_hyper_grad import update_hyper_grad, calculate_global_descent


if __name__ == '__main__':

    # parse args
    args = args_parser_fedhypgrad_2()
    ...
    for epoch_idx in range(args.epochs):
        ...
        for iu_idx, user_idx in enumerate(idxs_users): # updates that are only needed once per round
            ...
            hyper_grad_local_agg.append({'lr_local': train_out['lr_local_grad']})
        ...
        list_of_lr_vals = hyper_grad_vals['lr_local']
        print(f'Round {epoch_idx}: lr_local vals = {list_of_lr_vals}')
        # print status
