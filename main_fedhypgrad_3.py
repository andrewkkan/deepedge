...
from utils.options import args_parser_fedhypgrad_3 as args_parser_fedhypgrad
from models.client_HypGrad_3 import LocalClient_HypGrad
    ...
    for epoch_idx in range(args.epochs):
        ...
        for iu_idx, user_idx in enumerate(idxs_users): # updates that are only needed once per round
            ...
            local_user[user_idx].sync_update(
                ...
                lr_local = copy.deepcopy(hyper_grad_vals['lr_local']),
            )
        ...
        if args.hypergrad_on:
            ...
            lrl_grad_vals = hyper_grad_vals['lr_local']
            print(f"Round {epoch_idx}: {lrl_grad_vals}")
